...
> 指令：$ git log --pretty=oeline 

![1592276882139](Pictures/Git.md)

#### 6.5	克隆

> 指令：$ git clone +[url]()

![1592278795940](Pictures/1592278795940.png)

#### 6.6	查看历史记录版本号

> 查询指令：git reflog [文件名]，[查看历史记录的版本号]()
> 回退命令： git  reset  --hard  版本号 [回退到指定版本]()

#### 6.7	找回

> 指令： $ git checkout  b.txt
